<template>
  <div class="expand">
    <p class="warn-content">
      <a href="https://xiaoniezi.github.io/2017-10-16/vue-ElementUI-tree-expand/" target="_blank">Tree组件参考 tree</a>
    </p>
    <!--
      * highlight-current ：为了点击时节点高亮
      * expand-on-click-node : 只能箭头控制树形的展开收缩
      * render-content : 节点渲染方式
      * default-expanded-keys="[1]" ：默认展开第一个节点
      * node-key="id" 每个树节点用来作为唯一标识的属性 节点操作必须有
      * accordion 手风琴模式
    -->
    <div>
